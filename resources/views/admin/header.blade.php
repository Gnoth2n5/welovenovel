            ...
            <div class="navbar-brand">
                ...
                <a href="index.html">
                    ...
                    <span class="logo-text">
                        <!-- dark Logo text -->
                        <img src="{{asset('administrator/assets/images/logo-text.png')}}" alt="homepage" class="dark-logo" />
                        <!-- Light Logo text -->
                        <img src="{{asset('administrator/assets/images/logo-light-text.png')}}" class="light-logo" alt="homepage" />
                    </span>
                </a>
            </div>
            <!-- ============================================================== -->
                        ...
                        <form method="GET" action="{{ url('product_search') }}">
                            ...
                            <div class="customize-input">
                                <input class="form-control custom-shadow custom-radius border-0 bg-white"
                                    type="text" placeholder="Search" id="search-bar" name="search" aria-label="Search">
